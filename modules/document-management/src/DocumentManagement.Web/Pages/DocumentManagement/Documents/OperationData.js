    ...
    $(function () {
        ...
        function initGrdDocument() {
            ...
            grdDocument = new Tabulator("#grdDocument", {
                ...
                ajaxSorting: false,
                ajaxLoader: true,
                ajaxURL: '/api/document-management/documents/filtered-paged-list-by-document-type',
                ...
                ajaxURLGenerator: function (url, config, params) {
                    ...
                    return url + '?' + urlParameters + `&filter=${txtSearch.val()}&documentType=${documentType}&advancedSearch=${$('#AdvancedSearch').is(':checked')}`;//+ "?params=" + encodeURI(JSON.stringify(params)); //encode parameters as a json object
                },
