...
{
    public class DetailModel : DocumentManagementPageModel
    {
        [BindProperty]
        ...
        public virtual async Task<IActionResult> OnGetAsync(string code)
        {
            DocumentInfo = ObjectMapper.Map<DocumentDto, DocumentInfoViewModel>(await DocumentAppService.GetByCodeAsync(code));
